...
graph TD
    ...
    SYS_3V3 -->|TLV62569 Buck| SYS_1V1[1.1V Core (VL817/Switch)]
```
...
4. **T+22ms:** 2.5V LDO and 1.1V Buck stabilize.
...
| **1.1V** | TLV62569 (PGood) | None (Local Buck Protection). |
...
2. **Payload Off:** CM5 Disables `3V3_PCIE` Load Switch (Protect NVMe data).
